...
- (void)sample:(id)sender {
    ...
    for(NSScreen *screen in screens) {
        ...
        [line appendFormat:@" %.3f,%.3f,%.3f,%.3f,%.3f",r.origin.x,r.origin.y,r.size.width,r.size.height,[screen backingScaleFactor]];
    }
...
int main(void) { @autoreleasepool {
    ...
    [window setTitle:@"Logical output fixture"];[window orderFront:nil];
